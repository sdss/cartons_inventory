...
try:
    from cartons_inventory import __version__
except ModuleNotFoundError:
    from sdsstools import get_package_version
    __version__ = get_package_version(__file__, 'sdss-cartons_inventory') or 'dev'
...
project = 'cartons_inventory'
copyright = '{0}, {1}'.format('2022', 'Felipe Santana')
...
.. |cartons_inventory_version| replace:: {__version__}
"""
...
htmlhelp_basename = '{0}pdoc'.format('cartons_inventory')
...
man_pages = [
    (master_doc, 'cartons_inventory', u'{0} Documentation'.format(project),
     [author], 1)
]
...
if use_releases == 'yes':
    ...
    releases_github_path = 'sdss/cartons_inventory'
